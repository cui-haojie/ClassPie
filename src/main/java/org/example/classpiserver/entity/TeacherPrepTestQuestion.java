...
public class TeacherPrepTestQuestion {
    private Long id;
    private Long prep_item_id;
    ...
    public Long getPrep_item_id() { return prep_item_id; }
    public void setPrep_item_id(Long prep_item_id) { this.prep_item_id = prep_item_id; }
